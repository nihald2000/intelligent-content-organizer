...
class LLMService:
    ...
    async def answer_question(self, question: str, context: str, max_context_length: int = 30000) -> str:
...
Answer:"""
        ...
        try:
            answer = await self.generate_text(prompt, model="auto", max_tokens=3000, temperature=0.2)
            return answer.strip()
        except Exception as e:
